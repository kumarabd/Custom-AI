...
welcome = open(abs_path+"raw/welcome.txt", "r").read()
command = open(abs_path+"raw/commands.txt", "r").read()
maths = open(abs_path+"raw/maths.txt", "r").read()
random_things = open(abs_path+"raw/random.txt", "r").read()
...
save_documents = open(abs_path+"pickled/documents.pickle", "wb")
...
save_word_features = open(abs_path+"pickled/word_features.pickle", "wb")
...
save_featureset = open(abs_path+"pickled/featuresets.pickle", "wb")
...
save_classifier = open(abs_path+"pickled/originalnaivebayes.pickle", "wb")
...
save_classifier = open(abs_path+"pickled/MNB_classifier.pickle", "wb")
...
save_classifier = open(abs_path+"pickled/BernoulliNB_classifier.pickle", "wb")
...
save_classifier = open(abs_path+"pickled/LogisticRegression_classifier.pickle", "wb")
...
save_classifier = open(abs_path+"pickled/SGDC_classifier.pickle", "wb")
...
save_classifier = open(abs_path+"pickled/LinearSVC_classifier.pickle", "wb")
...
save_classifier = open(abs_path+"pickled/NuSVC_classifier.pickle", "wb")
